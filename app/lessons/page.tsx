...
const lessons = [
  {
    ...
    description: 'Learn the basics of Move programming language and understand objects, ownership, and functions.',
    duration: '15 min',
    xp: 100,
    difficulty: 'Beginner',
    topics: ['Objects', 'Ownership', 'Functions'],
    isLocked: false,
  },
  {
    id: 2,
    title: 'Working with Structs',
    description: 'Deep dive into Move structs, abilities, and how to create custom types.',
    duration: '20 min',
    xp: 150,
    difficulty: 'Beginner',
    topics: ['Structs', 'Abilities', 'Custom Types'],
    isLocked: true,
  },
  {
    id: 3,
    title: 'Transfer & Ownership',
    description: 'Master object transfer patterns and ownership rules in Move.',
    duration: '25 min',
    xp: 200,
    difficulty: 'Intermediate',
    topics: ['Transfer', 'Ownership', 'Patterns'],
    isLocked: true,
  },
];
