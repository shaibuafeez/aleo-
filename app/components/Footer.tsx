...
export default function Footer() {
  ...
  return (
    <footer className="bg-white text-black pt-20 pb-0 border-t border-gray-100 overflow-hidden relative">
      <div className="max-w-7xl mx-auto px-6 mb-32">
        <div className="grid grid-cols-2 md:grid-cols-12 gap-12 md:gap-8">
          ...
          <div className="col-span-2 md:col-span-4 flex flex-col justify-between h-full">
            <div>
              <Link href="/" className="text-xl font-bold tracking-tighter-swiss mb-6 block">
                Move By Practice.
              </Link>
          ...
          <div className="col-span-1 md:col-span-2">
            <h4 className="text-xs font-mono font-medium text-gray-400 uppercase tracking-widest mb-6">Product</h4>
          ...
          <div className="col-span-1 md:col-span-2">
            <h4 className="text-xs font-mono font-medium text-gray-400 uppercase tracking-widest mb-6">Resources</h4>
            <ul className="space-y-4">
          ...
          <div className="col-span-1 md:col-span-2">
            <h4 className="text-xs font-mono font-medium text-gray-400 uppercase tracking-widest mb-6">Legal</h4>
            <ul className="space-y-4">
